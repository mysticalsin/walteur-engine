...
case "${1:-}" in
  -h|--help)
  printf '%s\n' "adr-gate - unresolved fork and decision-record gate."
  printf '%s\n' "usage: bash adr-gate.sh [--selftest|--help|<default run>]"
  printf '%s\n' "report: walteur-kit/adr-report.json - fix recipes: walteur-kit/REMEDIATION.md (## adr-gate)"
  printf '%s\n' "bypass: WALTEUR_ADR=off (recorded, not free)"
  exit 0 ;;
esac
