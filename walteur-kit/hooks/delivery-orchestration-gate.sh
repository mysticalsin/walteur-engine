...
case "${1:-}" in
  -h|--help)
  printf '%s\n' "delivery-orchestration-gate - typed agent team and SDLC orchestration proof."
  printf '%s\n' "usage: bash delivery-orchestration-gate.sh [--selftest|--help|<default run>]"
  printf '%s\n' "report: walteur-kit/delivery-orchestration-report.json - fix recipes: walteur-kit/REMEDIATION.md (## delivery-orchestration-gate)"
  printf '%s\n' "bypass: WALTEUR_DELIVERY_ORCHESTRATION=off (recorded, not free)"
  exit 0 ;;
esac
