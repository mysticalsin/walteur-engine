...
case "${1:-}" in
  -h|--help)
  printf '%s\n' "compliance-gate - honest, mostly ZERO-DEP privacy/compliance gate."
  printf '%s\n' "usage: bash compliance-gate.sh [--selftest|--help|<default run>]"
  printf '%s\n' "report: walteur-kit/compliance-report.json - fix recipes: walteur-kit/REMEDIATION.md (## compliance-gate)"
  printf '%s\n' "bypass: WALTEUR_COMPLIANCE=off (recorded, not free)"
  exit 0 ;;
esac
