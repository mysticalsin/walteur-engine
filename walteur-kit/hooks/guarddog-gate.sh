...
case "${1:-}" in
  -h|--help)
  printf '%s\n' "guarddog-gate - novel / unindexed-malware supply-chain gate (pillar P13, EGRESS companion to osv-gate)."
  printf '%s\n' "usage: bash guarddog-gate.sh [--selftest|--help|<default run>]"
  printf '%s\n' "report: walteur-kit/guarddog-report.json - fix recipes: walteur-kit/REMEDIATION.md (## guarddog-gate)"
