...
case "${1:-}" in
  -h|--help)
  printf '%s\n' "doc-quality-gate - class-specific quality proof for the document build class."
  printf '%s\n' "usage: bash doc-quality-gate.sh [--selftest|--help|<default run>]"
  printf '%s\n' "report: walteur-kit/doc-quality-report.json - fix recipes: walteur-kit/REMEDIATION.md (## doc-quality-gate)"
  printf '%s\n' "bypass: WALTEUR_DOC_QUALITY=off (recorded, not free)"
  exit 0 ;;
esac
