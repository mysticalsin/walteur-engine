...
case "${1:-}" in
  -h|--help)
  printf '%s\n' "fitness-gate - architecture fitness functions: forbid cyclic dependencies and"
  printf '%s\n' "usage: bash fitness-gate.sh [--selftest|--help|<default run>]"
  printf '%s\n' "report: walteur-kit/fitness-report.json - fix recipes: walteur-kit/REMEDIATION.md (## fitness-gate)"
  printf '%s\n' "bypass: WALTEUR_FITNESS=off (recorded, not free)"
  exit 0 ;;
esac
