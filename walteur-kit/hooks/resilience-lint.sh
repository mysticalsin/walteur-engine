...
case "${1:-}" in
  -h|--help)
  printf '%s\n' "resilience-lint - ZERO-DEP HARD gate over source for resilience anti-patterns."
  printf '%s\n' "usage: bash resilience-lint.sh [--selftest|--help|<default run>]"
  printf '%s\n' "report: walteur-kit/resilience-report.json - fix recipes: walteur-kit/REMEDIATION.md (## resilience-lint)"
