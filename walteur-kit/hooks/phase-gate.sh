...
case "${1:-}" in
  -h|--help)
  printf '%s\n' "phase-gate - enforces ordered movement through the harness loop."
  printf '%s\n' "usage: bash phase-gate.sh [--selftest|--help|<default run>]"
  printf '%s\n' "report: walteur-kit/phase-gate-report.json - fix recipes: walteur-kit/REMEDIATION.md (## phase-gate)"
  exit 0 ;;
esac
