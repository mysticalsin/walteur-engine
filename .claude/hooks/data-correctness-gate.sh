#!/usr/bin/env bash
# WALTEUR data-correctness-gate — THIN SHIM (single source of truth).
#
# The ONE real implementation lives at  <repo>/walteur-kit/hooks/data-correctness-gate.sh  and is what
