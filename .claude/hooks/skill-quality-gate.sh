#!/usr/bin/env bash
# WALTEUR skill-quality-gate — THIN SHIM (single source of truth).
#
# The ONE real implementation lives at  <repo>/walteur-kit/hooks/skill-quality-gate.sh  and is what
