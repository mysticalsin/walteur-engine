#!/usr/bin/env bash
# WALTEUR apple-grade-design-gate — THIN SHIM (single source of truth).
#
# The ONE real implementation lives at  <repo>/walteur-kit/hooks/apple-grade-design-gate.sh  and is what
