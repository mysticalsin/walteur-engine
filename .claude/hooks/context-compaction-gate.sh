#!/usr/bin/env bash
# WALTEUR context-compaction-gate — THIN SHIM (single source of truth).
#
# The ONE real implementation lives at  <repo>/walteur-kit/hooks/context-compaction-gate.sh  and is what
