#!/usr/bin/env bash
# WALTEUR persona-breadcrumbs — THIN SHIM (single source of truth).
#
# The ONE real implementation lives at  <repo>/walteur-kit/hooks/persona-breadcrumbs.sh  and is what
