#!/usr/bin/env bash
# WALTEUR persona-coverage-gate — THIN SHIM (single source of truth).
#
# The ONE real implementation lives at  <repo>/walteur-kit/hooks/persona-coverage-gate.sh  and is what
