#!/usr/bin/env bash
# WALTEUR anti-slop-prose-gate — THIN SHIM (single source of truth).
#
# The ONE real implementation lives at  <repo>/walteur-kit/hooks/anti-slop-prose-gate.sh  and is what
