#!/usr/bin/env bash
# WALTEUR tool-liveness-probe — THIN SHIM (single source of truth).
#
# The ONE real implementation lives at  <repo>/walteur-kit/hooks/tool-liveness-probe.sh  and is what
