#!/usr/bin/env bash
# WALTEUR test-claim-verifier-gate — THIN SHIM (single source of truth).
#
# The ONE real implementation lives at  <repo>/walteur-kit/hooks/test-claim-verifier-gate.sh  and is what
